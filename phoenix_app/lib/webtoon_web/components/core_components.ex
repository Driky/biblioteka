defmodule WebtoonWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-4 right-4 z-50 w-80 sm:w-96 rounded-lg p-4 shadow-lg ring-1",
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="space-y-4">
        ...
        <div :for={action <- @actions} class="mt-4 flex items-center justify-end gap-6">
